...
template<class T> Callback_MessageIce_getContentPtr
newCallback_MessageIce_getContent(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MessageIce_getContent<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_MessageIce_getContentPtr
newCallback_MessageIce_getContent(T* instance, void (T::*cb)(const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MessageIce_getContent<T>(instance, cb, excb, sentcb);
}
...
template<class T, typename CT> Callback_MessageIce_getContentPtr
newCallback_MessageIce_getContent(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MessageIce_getContent<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_MessageIce_getContentPtr
newCallback_MessageIce_getContent(T* instance, void (T::*cb)(const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MessageIce_getContent<T, CT>(instance, cb, excb, sentcb);
}
...
template<class T> Callback_MessageIce_setContentPtr
newCallback_MessageIce_setContent(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MessageIce_setContent<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_MessageIce_setContentPtr
newCallback_MessageIce_setContent(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MessageIce_setContent<T>(instance, 0, excb, sentcb);
}

template<class T> Callback_MessageIce_setContentPtr
newCallback_MessageIce_setContent(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MessageIce_setContent<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_MessageIce_setContentPtr
newCallback_MessageIce_setContent(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_MessageIce_setContent<T>(instance, 0, excb, sentcb);
}
...
template<class T, typename CT> Callback_MessageIce_setContentPtr
newCallback_MessageIce_setContent(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MessageIce_setContent<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_MessageIce_setContentPtr
newCallback_MessageIce_setContent(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MessageIce_setContent<T, CT>(instance, 0, excb, sentcb);
}

template<class T, typename CT> Callback_MessageIce_setContentPtr
newCallback_MessageIce_setContent(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MessageIce_setContent<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_MessageIce_setContentPtr
newCallback_MessageIce_setContent(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_MessageIce_setContent<T, CT>(instance, 0, excb, sentcb);
}
